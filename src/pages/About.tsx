...
export default function About(): JSX.Element {
  const [plainText, setPlainText] = React.useState<string>('Loading...')
  ...
  // Parse plain text
  const [resultText, setResultText] = React.useState<Array<JSX.Element>>([<p key='loader'>Loading...</p>])
  React.useEffect(() => {
    setResultText(parseText(plainText, tagNames))
  }, [tagNames, plainText])
